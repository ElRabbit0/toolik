...
<body>
    ...
    ?>
    <button class="func-button back black-button" onclick="window.history.back();">
        <- Назад </button>
            <div id="page-account">
                <div class="info-acc">
                    <div class="info-icon">
                        ...
                        <form action="../pages/account-setting.php" enctype="multipart/form-data" method="post"
                            id="icon-form">
                ...
                <div class="edit-pass">
                    ...
                    <form action="../pages/account-setting.php" method="post" id="password-form">
                        <div class="input-box">
                            ...
                            <input minlength="8" type="text" name="old-password" id="old-password" required
                                placeholder="" required>
                        </div>
                        <div class="input-box">
                            <label for="new-password">Новый пароль</label>
                            <input minlength="8" type="text" name="new-password" id="new-password" required
                                placeholder="" required>
                        </div>
                        <div class="input-box">
                            <label for="ret-password">Повторите новый пароль</label>
                            <input minlength="8" type="text" name="ret-password" id="ret-password" required
                                placeholder="" required>
                        </div>
                    ...
                    <div id="error">
                        <?php
                        if ($_SESSION['error'] != '' && $_SESSION['error'] != ' ' && isset($_SESSION['error'])) {
                            echo $_SESSION['error'];
                        }
                        ?>
                    </div>
